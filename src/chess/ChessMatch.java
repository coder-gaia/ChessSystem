...
public class ChessMatch {
    ...
    private List<Piece> piecesThatWereCaptured = new ArrayList<>();
    ...
    public ChessPiece performChessMove(ChessPosition sourcePosition, ChessPosition targetPosition){
        ...
        Piece capturedPiece = makeAMove(source, target);
    ...
    public ChessPiece replacePromotedPiece(String type){
        if(promoted == null){
            throw new IllegalStateException("There ain't no piece to be promoted.");
        }
    ...
    private Piece makeAMove(Position source, Position target) {
        ...
        if(capturedPiece != null){
            ...
            piecesThatWereCaptured.add(capturedPiece);
        }
    ...
    private void undoMove(Position source, Position target, Piece capturedPiece){
        ...
        if(capturedPiece != null){
            ...
            piecesThatWereCaptured.remove(capturedPiece);
    ...
    private void validateSourcePosition(Position position){
        if(!board.isThereAPiece(position)){
            throw new ChessException("There ain't no piece at source position!");
        }
        ...
        if(!board.piece(position).isThereAnyPossibleMove()){
            throw new ChessException("There ain't no possible moves for the chosen piece!");
        }
    }
